  ...
  $("#nextQuestion").click(function () {
    ...
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      // ==============
        ...
        if (selectedRadioButtonIndex === 1) {
          currentQuestion = -1;
skipToEnd("Για μαθητές από χώρα της Ε.Ε. εκτός Ελλάδας τα Απαιτούμενα δικαιολογητικά είναι:
	Επίσημο απολυτήριο ή πιστοποιητικό φοίτησης
	Επίσημη μετάφραση στα Ελληνικά (αν χρειάζεται)
	Βεβαίωση αντιστοιχίας τάξης
	Υποβολή των εγγράφων στη Δευτεροβάθμια της περιοχής για ορθή τοποθέτηση βάσει των προγραμμάτων σπουδών και των δύο χωρών.
");
        } else if (selectedRadioButtonIndex === 2) {
          currentQuestion = -1;
          skipToEnd("Για μαθητές από χώρα εκτός Ε.Ε. τα Απαιτούμενα δικαιολογητικά είναι: 	Επίσημο απολυτήριο ή πιστοποιητικό φοίτησης
	Επίσημη μετάφραση στα Ελληνικά (αν το πρωτότυπο δεν είναι στα Ελληνικά)
	Βεβαίωση αντιστοιχίας τάξης
	Επικύρωση του εγγράφου (π.χ. προξενείο ή εκπαιδευτικό όργανο)
	Υποβολή των εγγράφων στη Δευτεροβάθμια της περιοχής για ορθή τοποθέτηση βάσει των προγραμμάτων σπουδών και των δύο χωρών.
");
        } else if (selectedRadioButtonIndex === 3) {
          currentQuestion = -1;
          skipToEnd("Για μαθητές από ελληνικό σχολείο εξωτερικού Απαιτούμενα δικαιολογητικά:
	Όλα τα έγγραφα όπως για σχολείο στην Ελλάδα
	Επιπλέον, επίσημη βεβαίωση φοίτησης από το συγκεκριμένο ελληνικό σχολείο στο εξωτερικό.
");
