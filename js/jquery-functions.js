    ...
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      // ==============
        ...
        if (selectedRadioButtonIndex === 1) {
          ...
          currentQuestion = -1;
          skipToEnd("Οι εγγραφές από το Δημοτικό στο Γυμνάσιο γίνονται αυτεπάγγελτα, χωρίς να απαιτούνται δικαιολογητικά, εφόσον η φοίτηση συνεχίζεται σε σχολείο της ίδιας περιοχής. Για την ολοκλήρωση της διαδικασίας, απαιτείται ιατρική βεβαίωση για τη Γυμναστική και η συμπλήρωση υπεύθυνων δηλώσεων που θα δοθούν από το σχολείο (φαρμακευτική αγωγή, συγκατάθεση για φωτογραφίες).");
        }
